...
// сортировка двумерного массива(по колонкам, так как в дз есть задание на сортировку по строкам).
...
if (LinearSearch2DArray(a, find, out i, out j))
    System.Console.WriteLine($"Element {find} is found in poisition {i}, {j}");
else
